...
namespace ReelJunkies.Services
{
    public class AppEmailSender : IAppEmailSender
    {
        ...
        public AppEmailSender(IOptions<MailSettings> mailSettings)
        {
            _mailSettings = mailSettings.Value;
        }

        public async Task SendContactEmailAsync(string emailFrom, string name,
        ...
        public async Task SendEmailAsync(string emailTo, string subject, string htmlMessage)
        {
            ...
            using var smtp = new SmtpClient();
            smtp.Connect(_mailSettings.Host,
                         _mailSettings.Port,
                         SecureSocketOptions.StartTls);

            smtp.Authenticate(_mailSettings.Mail,
